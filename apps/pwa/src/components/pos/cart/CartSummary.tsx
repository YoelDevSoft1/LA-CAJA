...
export function CartSummary({
    ...
    return (
        <div className="flex-shrink-0 p-4 sm:p-5 border-t border-border/40 bg-gradient-to-t from-background via-background/95 to-background/50 backdrop-blur-sm space-y-4">
            {!hasOpenCash && (
