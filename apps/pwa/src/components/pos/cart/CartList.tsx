        ...
        <div className="flex-1 min-h-0 relative">
            <ScrollArea className="h-full">
                <div className="flex flex-col">
                    {items.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-12 sm:py-24 text-muted-foreground px-4 text-center animate-in fade-in zoom-in duration-500 slide-in-from-bottom-4">
